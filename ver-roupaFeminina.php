 ...
 <div class="corpo-categorias ver-produto">
     <div class="linha">
         ...
         <div class="col-2">
             <img src="./img/roupaFeminina/roupa1.jpg" alt="" id="produtoImg">
             ...
             <div class="img-linha">
                 ...
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/roupaFeminina/roupa1.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
                 ...
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/roupaFeminina/roupa2.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
                 ...
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/roupaFeminina/roupa3.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
         ...
         <div class="col-2">
             ...
             <form action="adicionar.php" method="POST">
                 ...
                 <input type="hidden" name="id_produto" value="roupa_feminina_02">
                 <input type="hidden" name="nome" value="Roupa Feminina">
                 <input type="hidden" name="preco" value="150">
                 <input type="hidden" name="imagem" value="./img/roupaFeminina/roupa1.jpg">
