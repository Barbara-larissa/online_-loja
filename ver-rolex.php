...
<div class="corpo-categorias ver-produto">
    <div class="linha">
        <div class="col-2">
            <img src="./img/rolex/rolex1.jpg" alt="" id="produtoImg">
            <!--INICIO LINHA da  GALERIA-->
            <div class="img-linha">
                <!--INICIO ITEM GALERIA-->
                <div class="img-col">
                    <img src="./img/rolex/rolex1.jpg" alt="" width="100%" class="produtoMiniatura">
                </div>
                <!--FIM ITEM GALERIA-->
                <!--INICIO ITEM GALERIA-->
                <div class="img-col">
                    <img src="./img/rolex/rolex.webp" alt="" width="100%" class="produtoMiniatura">
                </div>
                <!--FIM ITEM GALERIA-->
                <!--INICIO ITEM GALERIA-->
                <div class="img-col">
                    <img src="./img/rolex/rolex2.webp" alt="" width="100%" class="produtoMiniatura">
                </div>
                <!--FIM ITEM GALERIA-->
            </div>
            <!--FIM  LINHA GALERIA-->
        ...
        <div class="col-2">
            ...
            <h4>R$ 15,0000</h4>
              <form action="adicionar.php" method="POST">
                ...
                <input type="hidden" name="id_produto" value="rolex_01">
                <input type="hidden" name="nome" value="Relógio">
                <input type="hidden" name="preco" value="150000">
                <input type="hidden" name="imagem" value="./img/rolex/rolex1.jpg">
                </select>
