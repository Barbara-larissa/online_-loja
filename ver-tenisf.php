...
<div class="corpo-categorias ver-produto">
    <div class="linha">
        <div class="col-2">
            <img src="./img/produto-11.jpg" alt="" id="produtoImg">
            <!--INICIO LINHA da  GALERIA-->
            <div class="img-linha">
                <!--INICIO ITEM GALERIA-->
                <div class="img-col">
                    <img src="./img/tenisFeminino/tenis1.jpg" alt="" width="100%" class="produtoMiniatura">
                </div>
                <!--FIM ITEM GALERIA-->
            </div>
            <!--FIM  LINHA GALERIA-->
        ...
        <div class="col-2">
            <h1>Tenis Feminino</h1>
            <h4>R$ 150.00</h4>

            <form action="adicionar.php" method="POST">

                <input type="hidden" name="id_produto" value="tenis_feminino_01">
                <input type="hidden" name="nome" value="Tênis feminino">
                <input type="hidden" name="preco" value="150">
                <input type="hidden" name="imagem" value="./img/produto-11.jpg">
