    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            <div class="col-2">
                <img src="./img/rouparosa/roupa2.webp" alt="" id="produtoImg">
                <!--INICIO LINHA da  GALERIA-->
                <div class="img-linha">
                    <!--INICIO ITEM GALERIA-->
                    <div class="img-col">
                        <img src="./img/rouparosa/roupa2.webp" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->
                    <!--INICIO ITEM GALERIA-->
                    <div class="img-col">
                        <img src="./img/rouparosa/roupa1.webp" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->
                    <!--INICIO ITEM GALERIA-->
                    <div class="img-col">
                        <img src="./img/rouparosa/ropa3.webp" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->
                </div>
                <!--FIM  LINHA GALERIA-->
            ...
            <div class="col-2">
                ...
                <form action="adicionar.php" method="POST">
                    ...
                    <input type="hidden" name="id_produto" value="blazer-rosa">
                    <input type="hidden" name="nome" value="blaser-rosa">
                    <input type="hidden" name="preco" value="150">
                    <input type="hidden" name="imagem" value="./img/rouparosa/roupa2.webp">
