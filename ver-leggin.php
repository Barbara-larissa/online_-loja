...
<div class="corpo-categorias ver-produto">
     <div class="linha">
         <div class="col-2">
             <img src="./img/leggie/foto2.jpg" alt="" id="produtoImg">
             <!--INICIO LINHA da  GALERIA-->
             <div class="img-linha">
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/leggie/foto2.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/leggie/foto3.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
                 <!--INICIO ITEM GALERIA-->
                 <div class="img-col">
                     <img src="./img/leggie/foto1.jpg" alt="" width="100%" class="produtoMiniatura">
                 </div>
                 <!--FIM ITEM GALERIA-->
             </div>
             <!--FIM  LINHA GALERIA-->
         ...
         <div class="col-2">
             ...
             <form action="adicionar.php" method="POST">
                ...
                <input type="hidden" name="id_produto" value="legging01">
                <input type="hidden" name="nome" value="legging">
                <input type="hidden" name="preco" value="150">
                <input type="hidden" name="imagem" value="./img/leggie/foto2.jpg">
